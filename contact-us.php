     ...
     <li>
              ...
              <!--   <h6>Have any question?</h6> -->
                                            ...
                                            <a href="#">1800 ITS BELLS </a> <br>
                                             ...
                                             <a href="tel:1800 487 235">1800 487 235 </a></div>
            </li>
            ...
            <li>
              ...
              <div class="text">
                <h6>Email</h6> 
                <a href="mailto:info@bellsnss.com.au">info@bellsnss.com.au</a> </div>
            </li>
      ...
      <div class="col-xl-7 col-lg-6 formm">
        ...
        <form id="contact_form" name="contact_form"  action="contact-us.php" method="post">
         <div class="row">
                  <div class="col-lg-12">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <div class="input-group">
                        <input name="phone" type="tel" class="form-control"   placeholder="Phone Number *" value="<?php if(isset($phone)){ echo $phone; } ?>">
