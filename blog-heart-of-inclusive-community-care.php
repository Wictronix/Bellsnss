            ...
            <div class="auto-container">
                <div class="title-outer text-center">
                    <ul class="page-breadcrumb">
                        ...
                        <li>The Heart of Inclusive Community Care</li>
                    </ul>
                    <h1 class="title">THE HEART OF INCLUSIVE COMMUNITY CARE</h1>
                </div>
            </div>
        </section>
        <!--End Bread Crumb -->
                    ...
                    <div class="col-lg-12">
                        <div class="blog-detail">
                            <div class="blog-header">
                                <h1 class="blog-title">The Heart of Inclusive Community Care</h1>
                                <div class="blog-meta">
                                    <span class="date">Published on October 29, 2025</span>
                                    <span class="category">Community Care</span>
                                </div>
                            </div>

                            <div class="blog-image">
                                <img src="images/blogs/blog5.jpg" alt="Inclusive community care" class="img-fluid">
                            </div>
                            ...
                            <div class="blog-content">
                                ...
                                <div class="blog-tags">
                                    ...
                                    <span class="tag">nursingvictoria</span>
